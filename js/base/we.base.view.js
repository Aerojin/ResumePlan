...
(function (jQuery, WE) {
   ...
   */
    ...
    WE.View.ViewBase = Backbone.View.extend(
    /**
    *@lends WE.View.ViewBase.prototype
    */
    {
        /**
        *所有View的基类,主要为了统一常用事件、方法的命名
        *@constructs WE.View.ViewBase
        *@require WE.Dom
        ...
        */
        initialize: function (options) {
            ...
            WE.View.registerView(this.id, this);
        },
        ...
        */
        render: function () {
            ...
            *容器dom生成
            *@event 
            *@name WE.View.ViewBase#render
            */
            this.trigger("render");
            /**
            *假设对象调用render函数后随即添加到dom中，在下一个时间片触发print
            *@event 
            *@name WE.View.ViewBase#print
            */
            setTimeout(function () {
                This.trigger("print");
            }, 0);
    ...
    /**@lends WE.View*/
    {
        ...
        *@param {String} id 继承自WE.View.ViewBase的对象的id
        *@example
        var html = "&lt;input value=\"按钮\" onclick=\"WE.View.getView('{id}').doSomething()\" /&gt;";
        */
        getView: function (id) {
        ...
        *@param {String} id  继承自WE.View.ViewBase的对象的id
        *@param {WE.View.ViewBase} view 继承自WE.View.ViewBase的对象
        */
